...
function sendMail($filename,$email){
    ...
    // Fetch user data
    echo  "SELECT * FROM employees WHERE Email = '$email'";
    $qry = mysqli_query($con, "SELECT * FROM employees WHERE Email = '$email'");
...
// $filename="mailBodyEmployee.html";
// $email="krishnajoshi5129@gmail.com";
